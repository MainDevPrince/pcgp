<?php
    ...
    $message .= "<h1>".str_replace("aA","'",$description)."<br />invest amount: ".$investamount."&euro;"."<br />invest period:".$investperiod."<br />contact date :".$timestamp."</h1><br />".'<div style="border:none;border-radius:3px;color:white;padding:15px" bgcolor="#5865f2"><a href="https://www.grootpandacoin.com/contact-to.html?param=';  
    $param='to='.$email.'&fn='.$firstName.'&ln='.$lastName.'&mn='.$mobile.'&ia='.$investamount.'&ip='.$investperiod.'&ds='.$description; 
    $enparam=encrypt($param,"pcgp love manager");
