...
function getLanguage() {
    ...
    $('#third_section_subtitle').text(language.third_section_subtitle);
    ...
    $('#fourth_section_left_slogan').text(language.fourth_section_left_slogan);
    ...
    if (localStorage.getItem('language') == 'cn') lang_file = 'cn';
    else lang_file = 'en';
